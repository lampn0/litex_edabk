...
_io = [
    ...
    ("user_led", 16, Pins("G16"), IOStandard("3.3-V LVTTL")),
    ("user_led", 17, Pins("H15"), IOStandard("3.3-V LVTTL")),
    ...
    #("cpu_reset", 0, Pins("C12"), IOStandard("3.3-V LVTTL")),
]
...
platform.build(module, build_dir  = "build_de2_s003_switches", build_name="de2_s003_switches")
